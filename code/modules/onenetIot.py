...
from usr.modules.common import Thread
from usr.modules.common import CloudObservable
from usr.modules.utils import new as hmac_new, sha256, b64encode, b64decode
...
class OneNetIot(CloudObservable):
    ...
    def __recv_callback(self, topic, data):
        ...
        self.notifyObservers('raw_data', {'topic': topic, 'data': data})
